...
require_once "./train-report.inc.php";
...
<head>
    ...
    <title>Training and Awareness Report</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
        <div class="content">
            <p class="display-3 text-center">Training and Awareness Report</p>
    ...
    <script>
        ...
        $("#update-response-form").submit(function(e) {
            ...
            $.post("training-report.php", formData, function(response) {
                // Redirect to this page to refresh the report table
                window.location.href = "training-report.php";
            });
        });
    </script>
</body>
