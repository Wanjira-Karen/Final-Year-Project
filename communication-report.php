...
require_once "./communication-report.inc.php";
...
<head>
    ...
    <title>Subject Communication Report</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
        <div class="content">
            <p class="display-3 text-center">Subject Communication Report</p>
    ...
    <script>
        ...
        $("#update-response-form").submit(function(e) {
            ...
            $.post("communication-report.php", formData, function(response) {
                // Redirect to this page to refresh the report table
                window.location.href = "communication-report.php";
            });
        });
    </script>
</body>
