...
require_once "./policy-report.inc.php";
...
<head>
    ...
    <title>Policy Adherence Report</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
        <div class="content">
            <p class="display-3 text-center">Policy Adherence Report</p>
    ...
    <script>
        ...
        $("#update-response-form").submit(function(e) {
            ...
            $.post("policy-report.php", formData, function(response) {
                // Redirect to this page to refresh the report table
                window.location.href = "policy-report.php";
            });
        });
    </script>
</body>
