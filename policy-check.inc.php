...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    while ($item = mysqli_fetch_assoc($result)) {
        ...
        $stmt = $conn->prepare("INSERT INTO policy_responses (controller, item, response_status) VALUES (?, ?, ?)");
    ...
    header("Location: policy-check.php?success=true");
    exit();
}
